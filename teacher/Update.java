...
public class Update extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e){
        ...
        try{
            ...
            PreparedStatement statement = connection.prepareStatement("UPDATE STUDENTS SET name=?, maths=?, physics=?, chemistry=?, total=? WHERE regno=?");
            
            statement.setString(1, name);
            statement.setDouble(2, maths);
            statement.setDouble(3, physics);
            statement.setDouble(4, chemistry);
